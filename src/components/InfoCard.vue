        ...
        <b-col md="4" v-for="(item, index) in likeList" :key="index">
          ...
          >
            <b-card-text>
              ...
              濕度:{{ item.moisture }}
              <br />
              氣壓:{{ item.atmosphericPressure }}
              <br />
              天氣:{{ item.weather }}
              <br />
              降雨機率:{{ item.rainfall1day }}
              <br />
              測量單位:{{ item.unit }}
              <br />
            ...
            <b-button variant="primary" @click="removeItemToLike(item)">移除最愛</b-button>
          </b-card>
        </b-col>
      </b-row>
    </b-container>
      ...
      <b-row>
        <b-col md="4" v-for="(item, index) in infoList" :key="index">
          ...
          >
            ...
            <b-button variant="primary" @click="addItemToLike(item)">加入最愛</b-button>
          </b-card>
        </b-col>
      </b-row>
    </b-container>
